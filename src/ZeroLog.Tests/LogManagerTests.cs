...
namespace ZeroLog.Tests
{
    ...
    public class LogManagerTests
    {
        ...
        public unsafe void should_not_throw_if_formatting_fails_when_appending_formatted_arguments()
        {
            ...
            var logMessage = _testAppender.LoggedMessages.Single();
            Check.That(logMessage).Equals("An error occured during formatting: \"Hello\", False, 1, 'a', 2, 3, 4, 5, 6, 7, " + guid + ", 2017-02-24 16:51:51.000, 16:51:51.0000000, \"abc\", \"abc\", Friday");
        }
