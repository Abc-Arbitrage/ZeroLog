...
namespace ZeroLog
{
    ...
    public class ConcurrentStack<T> : IProducerConsumerCollection<T>, IReadOnlyCollection<T>
    {
        ...
        private void OnDeserialized(StreamingContext context)
        {
            ...
            for (var i = 0; i < _serializationArray.Length; i++)
            {
                var currNode = new Node(_serializationArray[i]);
        ...
        public int Count
        {
            ...
            get
            {
                ...
                for (var curr = _head; curr != null; curr = curr._next)
                {
...
#pragma warning disable 0420 // No warning for Interlocked.xxx if compiled with new managed compiler (Roslyn)
        ...
        /// </summary>
        /// <param name="item">
        /// The object to push onto the <see cref="ConcurrentStack{T}" />. The value can be
        ...
        /// inserting elements onto the top of the <see cref="ConcurrentStack{T}" />.
        /// </param>
        /// <param name="count">
        ...
        /// </exception>
        /// <exception cref="ArgumentOutOfRangeException">
        /// <paramref name="startIndex" /> or
        /// <paramref
        ///     name="count" />
        /// is negative. Or <paramref name="startIndex" /> is greater than or equal to the length
        /// of <paramref name="items" />.
        /// </exception>
        /// <exception cref="ArgumentException">
        /// <paramref name="startIndex" /> + <paramref name="count" /> is
        /// greater than the length of <paramref name="items" />.
        /// </exception>
        /// <remarks>
        /// When adding multiple items to the stack, using PushRange is a more efficient
        /// mechanism than using <see cref="Push" /> one item at a time. Additionally, PushRange
        ...
        /// <summary>
        /// Push one or many nodes into the stack, if head and tails are equal then push one node to the stack other wise push the
        /// list between head
        ...
        /// <remarks>
        /// For <see cref="ConcurrentStack{T}" />, this operation
        ...
        /// </summary>
        /// <param name="items">
        /// The <see cref="T:System.Array" /> to which objects popped from the top of the
        /// <see
        ///     cref="ConcurrentStack{T}" />
        /// will be added.
        /// </param>
        ...
        /// <param name="startIndex">
        /// The zero-based offset in <paramref name="items" /> at which to begin
        /// inserting elements from the top of the <see cref="ConcurrentStack{T}" />.
        /// </param>
        /// <param name="count">
        /// The number of elements to be popped from top of the
        /// <see
        ///     cref="ConcurrentStack{T}" />
        /// and inserted into <paramref name="items" />.
        /// </param>
        /// <returns>
        /// The number of objects successfully popped from the top of
        /// the <see cref="ConcurrentStack{T}" /> and inserted in <paramref name="items" />.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="items" /> is a null reference
        /// (Nothing in Visual Basic).
        ...
        public int TryPopRange(T[] items, int startIndex, int count)
        {
            ...
            Node poppedHead;
            var nodesCount = TryPopCore(count, out poppedHead);
            if (nodesCount > 0)
            {
...
#pragma warning restore 0420
        ...
        /// <remarks>
        /// For <see cref="ConcurrentStack{T}" />, this operation will attempt to pope the object at
